package net.flashpunk 
{
	...
	public class Splash extends Entity
	{
		 ...
		 * Embedded graphics.
		 */
		[Embed(source = '../../../lib/splash_lines.png')] private const SPLASH_LINES:Class;
		[Embed(source = '../../../lib/splash_cog.png')] private const SPLASH_COG:Class;
		[Embed(source = '../../../lib/splash_left.png')] private const SPLASH_LEFT:Class;
		[Embed(source = '../../../lib/splash_right.png')] private const SPLASH_RIGHT:Class;
